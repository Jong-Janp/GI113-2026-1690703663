...
namespace Lab02
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"MaxAD: {maxAD}");
            Console.WriteLine($"AD: {currentAD}");
            Console.WriteLine($"Luck: {luck}");
            Console.WriteLine($"DPS: {DPS}");
            Console.WriteLine($"IsHumanoid: {isHumanoid}");
            Console.WriteLine();
            int ADPercent = currentAD * 100 / maxAD;
            Console.WriteLine($"AD percent: {ADPercent}%");
            Console.WriteLine();
            currentAD = currentAD * 60;
            Console.WriteLine();
            Console.WriteLine("===== BOSS STATUS: AFTER DAMAGE =====");
            Console.WriteLine($"AD: {currentAD} / {maxAD}");
            ADPercent = currentAD * 100 / maxAD;
            Console.WriteLine($"AD Precent: {ADPercent}%");
            ...
            Console.WriteLine($"CurrentIq: {currentIq}");
            Console.WriteLine($"maxIq: {maxIq}");
            Console.WriteLine($"BrainSpeed: {brainSpeed}");
            Console.WriteLine($"IsHuman: {isHuman}");
            Console.WriteLine();
            int iqPercent = currentIq * 100 / maxIq;
            Console.WriteLine($"Iq percent: {iqPercent}%");
            Console.WriteLine();
            currentIq = currentIq * 60;
            Console.WriteLine();
            Console.WriteLine("===== BOSS STATUS: AFTER DAMAGE =====");
            Console.WriteLine($"Iq: {currentIq} / {maxIq}");
            iqPercent = currentIq * 100 / maxIq;
            Console.WriteLine($"Iq Precent: {iqPercent}%");
